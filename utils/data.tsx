...
export type EducationalResource = {
  name: string;
  abstract: string;
  authors: Array<string | object>;
  dateTime?: number;
  contributors?: Array<string | object>;
...
export const educationalResources: (
...
)[] = [
  {
    ...
    abstract:
      "Une aventure d'apprentissage vidéoludique pour le langage statistique R, à partager au sein du SSP (et du royaume de Statis). Pour en savoir plus, consulter le site https://funcamp.sspcloud.fr/",
    imageUrl: gameControllerImgUrl,
    parts: [
      {
        name: "icaRius",
        abstract:
          "La partie vidéoludique du FuncampR. Jeux de rôle inspiré d'un célèbre jeu vidéo des années 1990...",
        authors: [
          "A. Degorre",
          {
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 1 : la maison d’icaRius. Découverture du grimoire IgoR et de la langue des Runes",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 2 : la poule pondeuse. Dans le village de Kokoro, icaRius aide la fermière à recomposer le livre des pontes...",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 3 :  le village de GrissGrass. Le chef du village demande à icaRius de trouver quelle est l’exploitation la plus productive en herbe de Mandragore.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 4 :  le secret de la culture de Mandragore. IcaRius doit retrouver la recette de la culture de la Mandragore.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 5 :  le cuistot Batreb. Pour libérer Essespéus dans le château de Statis, icaRius doit d’abord obtenir la confiance du cuistot Batreb.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 6 : la fake news. Essespéus et icaRius vont créer une Fake News pour tromper les armées de SaSSoS.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 7 (optionnel): le labyrinthe. Le Mage Delagarde propose à icaRius un défi pour obtenir les bonnes directions dans le labyrinthe.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 8: la plume d’IgoR. Pour soulever la pierre qui bloque le passage, icaRius doit apprendre de nouveaux sortilèges.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 9: le village de Sandia. Mam’Grouxi narre les innombrables naissances qu’elle a vu au fil des ans (des siècles?).",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 10: La porte de sortie - Save Me. Dans ses pérégrinations, icaRius se trouve pris au piège dans une salle de l'impossible",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 11: Codez-le une fois. L'automate TeoC enseigne à icaRius la Voie du Reproductible",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 12: De l’oxygène documentaire. Rencontre d'un drôle d’oiseau, FebeleR, féru de littérature statisienne et de grimoires...",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Chapitre 13: l'histoire sans fin. La gueRnouille Asa apprend à icaRius à écrire lui-même la fin de l'histoire",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
      ...
      },
      {
        ...
        abstract:
          "Partie pédagogique du FuncampR. Le parchemin pour écrire soi-même le chapitre 13 et la fin de l'histoire d'icaRius.",
        authors: [
          {
            fr: "Communauté FuncampR",
            en: "FuncampR Community",
